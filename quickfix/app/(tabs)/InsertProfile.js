...
export default function InsertProfile({navigation}) {
  ...
  const saveProfile = async () => {
    ...
    try {
      const response = await fetch('http://192.168.57.110:3000/api/profile', {
        method: 'POST',
        headers: {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.header}>
        <Image source={require('../../assets/images/logoq.png')} style={styles.logo} />
      </View>
      {/* Image Picker */}
